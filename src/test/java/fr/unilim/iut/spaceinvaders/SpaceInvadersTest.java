...
public class SpaceInvadersTest {
   ...
   public void test_AuDebut_JeuSpaceInvaderEstVide() {
    ...
    public void test_EnvahisseurAvance_EnvahisseurSeDeplaceVerLaDroite(){
    	spaceinvaders.positionnerUnNouvelEnvahisseur(new Dimension(3,2), new Position(6,1), 1);
    	spaceinvaders.deplacerEnvahisseursVersLaDroite();
    ...
    public void test_EnvahisseurAvance_EnvahisseurSeDeplaceVerLaGauche(){
    	spaceinvaders.positionnerUnNouvelEnvahisseur(new Dimension(3,2), new Position(6,1), 1);
    	spaceinvaders.deplacerEnvahisseursVersLaGauche();
     ...
     @Test
     public void test_missilesNePeuventPasSeChevaucher() {
     	spaceinvaders.positionnerUnNouveauVaisseau(new Dimension(7, 2), new Position(5, 9), 1);
     	spaceinvaders.tirerUnMissile(new Dimension(3, 2), 1);
     	spaceinvaders.deplacerMissiles();
     ...
     @Test
     public void test_ligneEnvahisseursSeDeplaceAutomatiquement() {
    	 for (int i=0; i<3; i++) {
    ...
    @Test
    public void test_arretPartieApresDestructionDeTousLesEnvahisseurs() {
       ...
       assertEquals(true , Collision.detecterCollision(spaceinvaders.recupererUnSeulEnvahisseur(0), spaceinvaders.recupererUnSeulMissile(0)));
